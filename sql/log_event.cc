...
Delete_rows_log_event::do_before_row_operations(const Slave_reporting_capability *const)
{
  ...
  */
  ...
  if (slave_run_triggers_for_rbr && !master_had_triggers)	// check if this should come after
    m_table->prepare_triggers_for_delete_stmt_or_event();	// this line :: thd->lex->sql_command= SQLCOM_DELETE;
